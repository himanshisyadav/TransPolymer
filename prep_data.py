...
def ce_data_exact_paper_seq_fusion_scaled(train_num_file, train_smiles_file, train_output_file, test_num_file, test_smiles_file, test_output_file):
    ...
    def final_save(df_input, output_file):
        ...
        df_input['properties'] = df_input[['additive_smiles','protocol','current_density']].apply("$".join, axis=1)
    ...
    scaler = load('./data/new-electrolyte-data/std_scaler_ce_train_rand_features.bin')
    ...
    # dump(scaler, './data/new-electrolyte-data/std_scaler_ce_train_rand_features.bin', compress=True)

    # sc = StandardScaler()
    sc = load('./data/new-electrolyte-data/std_scaler_ce_train_rand_CE_comm.bin')
    # df_input_train['log(1-CE)'] = sc.fit_transform(df_input_train['log(1-CE)'].values.reshape(-1, 1))
    df_input_train['log(1-CE)'] = sc.transform(df_input_train['log(1-CE)'].values.reshape(-1, 1))
    df_input_test['log(1-CE)'] = sc.transform(df_input_test['log(1-CE)'].values.reshape(-1, 1))
    # dump(sc, './data/new-electrolyte-data/std_scaler_ce_train_rand_CE_comm.bin', compress=True)
...
def main():
    ...
    # ood_scaled("./data/cond_ood_final_add.csv", "./data/cond_ood_final_comp.csv", "/project/rcc/hyadav/TransPolymer_2/data/new-chemprop-data/ood_test_datasets/cond_ood_exact_strat_scaled_fusion_no_mol_new_log10.csv")
    ...
    # ce_data_exact_paper_seq_fusion_scaled("./data/new-electrolyte-data/train_CE_rand_add.csv", "./data/new-electrolyte-data/train_CE_rand_comp_comm.csv", "./data/new-electrolyte-data/train_CE_rand_exact_all_scaled_nonfusion_no_mol_new_comm.csv", 
    #                               "./data/new-electrolyte-data/test_CE_rand_add.csv", "./data/new-electrolyte-data/test_CE_rand_comp_comm.csv", "./data/new-electrolyte-data/test_CE_rand_exact_all_scaled_nonfusion_no_mol_new_comm.csv")
    
    # ce_data_exact_paper_seq_fusion_scaled("./data/new-electrolyte-data/train_CE_clus1_add.csv", "./data/new-electrolyte-data/train_CE_clus1_comp_comm.csv", "./data/new-electrolyte-data/train_CE_clus1_exact_all_rand_scaled_nonfusion_no_mol_new_comm.csv", 
    #                               "./data/new-electrolyte-data/test_CE_clus1_add.csv", "./data/new-electrolyte-data/test_CE_clus1_comp_comm.csv", "./data/new-electrolyte-data/test_CE_clus1_exact_all_rand_scaled_nonfusion_no_mol_new_comm.csv")
